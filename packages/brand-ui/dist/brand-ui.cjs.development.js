...
var mergeSx = _interopDefault(require('deepmerge'));
var reakit = require('reakit');
var focus = require('@react-aria/focus');
var Disclosure = require('reakit/Disclosure');
var invariant = _interopDefault(require('tiny-invariant'));
var Checkbox$1 = require('reakit/Checkbox');
var Input$1 = require('reakit/Input');
var _ = require('reakit/Tooltip/');
var Popover$2 = require('reakit/Popover');
...
function Fonts() {
  return React__default.createElement(core.Global, {
    styles: core.css(_templateObject(), VtexTrustVariableWoff2, VtexTrustVariableWoff, VtexTrustRegularWoff2, VtexTrustRegularWoff, VtexTrustMediumWoff2, VtexTrustMediumWoff)
  });
}

var Fonts$1 = /*#__PURE__*/React.memo(Fonts);

function ThemeProvider(_ref) {
  var children = _ref.children;
  return React__default.createElement(themeUi.ThemeProvider, {
    theme: theme
  }, React__default.createElement(Fonts$1, null), children);
}

var Provider = /*#__PURE__*/React.memo(ThemeProvider);
...
var useTheme = function useTheme() {
  return React.useContext(core.ThemeContext);
};
...
function Button(props, ref) {
  ...
  return themeUi.jsx(reakit.Button, Object.assign({
    ref: ref
  }, buttonProps, {
    sx: _extends({
      variant: variant
...
function useFocusHollow(params) {
  ...
  var focusStyles = isFocusVisible || params !== null && params !== void 0 && params.showFocusOnInit && isFocused ? {
    boxShadow: "0px 0px 0px " + css.get(theme, 'space.2') + "px " + css.get(theme, 'colors.focus')
  } : {};
  return {
...
var Button$1 = /*#__PURE__*/forwardRef(function (props, ref) {
  ...
  return React__default.createElement(BaseButton, Object.assign({
    variant: "buttons." + variant + "-" + resolvedSize,
    sx: mergedSx,
    ref: ref
  }, restProps, focusProps), React__default.createElement(themeUi.Flex, {
    sx: _extends({
      alignItems: 'center',
      justifyContent: 'center',
      margin: 'auto',
...
var Icon = /*#__PURE__*/forwardRef(function (props, ref) {
  ...
  return themeUi.jsx("svg", Object.assign({
    ...
    viewBox: viewBox,
    fill: fill
  }, svgJSXProps), title && themeUi.jsx("title", null, title), children);
});
...
function IconCaret(props) {
  ...
  return React__default.createElement(Icon, Object.assign({}, iconProps, {
    sx: _extends({}, sx, {
...
var IconMail = function IconMail(props) {
  return React__default.createElement(Icon, Object.assign({}, props), React__default.createElement("path", {
    fillRule: "evenodd",
    clipRule: "evenodd",
...
var socialMediaLinks = [{
  ...
  icon: /*#__PURE__*/React__default.createElement(IconFacebook, {
    size: ICON_SIZE
  })
}, {
  name: 'Instagram',
  to: 'https://www.instagram.com/vtexcommerce/',
  icon: /*#__PURE__*/React__default.createElement(IconInstagram, {
    size: ICON_SIZE
  })
}, {
  name: 'YouTube',
  to: 'https://www.youtube.com/user/VTEXTV/',
  icon: /*#__PURE__*/React__default.createElement(IconYouTube, {
    size: ICON_SIZE
  })
}, {
  name: 'LinkedIn',
  to: 'https://www.linkedin.com/company/vtex/',
  icon: /*#__PURE__*/React__default.createElement(IconLinkedIn, {
    size: ICON_SIZE
  })
}];
...
var Group = function Group(_ref2) {
  ...
  }, title), React__default.createElement(themeUi.Box, {
    sx: {
      width: '100%',
      display: ['flex', 'block'],
      justifyContent: 'space-between',
...
var Link = /*#__PURE__*/forwardRef(function (props, ref) {
  ...
  return React__default.createElement(themeUi.Link, Object.assign({
    sx: mergedSx,
    href: href,
    ref: ref
  }, restProps), children);
...
var SocialMedia = function SocialMedia() {
  return React__default.createElement(themeUi.Flex, null, socialMediaLinks.map(function (socialMediaLink) {
    return React__default.createElement(SocialMediaIcon, {
...
var FooterLanding = function FooterLanding(_ref) {
  ...
  }, React__default.createElement(IconVTEX, {
    size: 80
...
function useCollapsibleContext() {
  ...
  !context ?  invariant(false, "Do not use Collapsible's composites outside of Collapsible context")  : void 0;
  return context;
}
function CollapsibleProvider(_ref) {
  ...
  return React__default.createElement(CollapsibleContext.Provider, {
...
function Collapsible(_ref) {
  ...
  return React__default.createElement(themeUi.Box, {
    variant: "collapsible",
    sx: sx
  }, React__default.createElement(CollapsibleProvider, Object.assign({}, props), children));
}
...
function Header(_ref2) {
  ...
  return React__default.createElement(reakit.Disclosure, Object.assign({
    visible: visible
  }, disclosureProps), function (enhancedProps) {
    return React__default.createElement(themeUi.Flex, Object.assign({
      as: "button"
    ...
    }, renderIcon(prefix, contentVariant), React__default.createElement(themeUi.Text, {
      variant: contentVariant
    }, label), renderIcon(suffix)), React__default.createElement(IconCaret, {
      duration: 0.3,
...
var contentAnimation = /*#__PURE__*/core.css( /*#__PURE__*/_templateObject$1());
...
function Content(_ref3) {
  ...
  return React__default.createElement(Disclosure.DisclosureContent, Object.assign({}, state, {
    css: state.animated && contentAnimation
  }), function (enhancedProps) {
    return React__default.createElement(themeUi.Box, Object.assign({}, enhancedProps, {
      variant: variant,
      sx: sx
    }), children);
  });
...
var useAccordion = function useAccordion(_ref) {
  ...
  var _useState = React.useState((_initialState$visible = initialState === null || initialState === void 0 ? void 0 : initialState.visible) !== null && _initialState$visible !== void 0 ? _initialState$visible : -1),
  ...
  var useCollapsibles = Array.from({
    ...
    return Disclosure.useDisclosureState({
      animated: animated
    });
  });
...
function Accordion(_ref3) {
  ...
  var createSection = function createSection(child, key) {
    ...
    return React__default.createElement(Collapsible, props, child.props.children);
  };

  var items = React.Children.map(children, createSection);
  return React__default.createElement(themeUi.Box, {
    variant: "accordion"
  }, items);
}
...
var IconArrowRight = function IconArrowRight(props) {
  return React__default.createElement(Icon, Object.assign({}, props), React__default.createElement("svg", {
    version: "1.1",
    viewBox: "0 0 16 16",
    xmlns: "http://www.w3.org/2000/svg",
    x: "0px",
...
var Image = /*#__PURE__*/forwardRef(function (props, ref) {
  return React__default.createElement(themeUi.Image, Object.assign({}, props, {
    ref: ref
  }));
});
...
var Title = function Title(props) {
  return React__default.createElement(themeUi.Flex, Object.assign({}, props, {
    variant: "card.noMedia.header.title"
  }), props.children, props.icon && React__default.createElement(IconArrowRight, {
    size: 20
  }));
};
...
var Card = function Card(_ref) {
  ...
  return React__default.createElement(themeUi.Flex, Object.assign({}, props, {
    ...
    as: el,
    sx: sx
  }), src && React__default.createElement(themeUi.Flex, {
...
var BrandCheckbox = function BrandCheckbox(_ref, ref) {
  ...
  }, themeUi.jsx(Checkbox$1.Checkbox, Object.assign({
    disabled: disabled,
    ref: ref,
    sx: {
      variant: "checkbox" + (error ? '.error' : '')
    }
  }, restProps)), label), error && errorMessage && themeUi.jsx(themeUi.Text, {
...
var HamburgerMenu = function HamburgerMenu(_ref) {
  ...
  return themeUi.jsx(React.Fragment, null, themeUi.jsx(reakit.Disclosure, Object.assign({}, disclosure, {
    role: "presentation",
    sx: {
      variant: 'hamburgerMenu'
    }
  }), disclosure.visible ? themeUi.jsx(themeUi.Box, {
    sx: {
      color: 'secondary.base'
    }
  }, themeUi.jsx(IconExit, {
    size: 24
  })) : themeUi.jsx(IconHamburger, {
    size: 24
  })), themeUi.jsx(reakit.DisclosureContent, Object.assign({}, disclosure, {
    sx: _extends({
...
var Links = function Links(_ref3) {
  ...
  return themeUi.jsx(themeUi.Link, {
    href: to,
    variant: variant,
    sx: sx
  }, title);
...
var LocaleSwitcher = function LocaleSwitcher(_ref2) {
  ...
  return themeUi.jsx(themeUi.Box, {
  ...
  }, themeUi.jsx(reakit.Disclosure, Object.assign({
    sx: {
      variant: 'localeSwitcher.large'
    }
  }, disclosure), themeUi.jsx(IconGlobe, {
    sx: {
      ml: 5
    },
    size: 22
  ...
  }, getLocaleLabel()), themeUi.jsx(IconCaret, {
    sx: {
      position: 'absolute',
      right: 4
    },
    ...
    size: 30
  })), themeUi.jsx(reakit.Disclosure, Object.assign({}, disclosure, {
    sx: {
...
var Brand = function Brand(_ref2) {
  var _ref2$noMargin = _ref2.noMargin,
      ...
      children = _ref2$children === void 0 ? React__default.createElement(IconVTEXExpanded, {
    size: 35
  }) : _ref2$children;
  var sx = noMargin ? {
    marginX: '0'
  } : {};
  return React__default.createElement(themeUi.Link, {
    href: "/",
...
var useInputState = function useInputState(_ref2) {
  ...
  var _useState2 = React.useState(value ? value.toString().length : 0),
      charCount = _useState2[0],
      setCharCount = _useState2[1];

  var _useState3 = React.useState(charCount > 0),
      filled = _useState3[0],
      setFilled = _useState3[1];

  var _useState4 = React.useState(charLimit ? charCount > charLimit : false),
  ...
  var _useState5 = React.useState(resolveInputState({
    disabled: disabled,
    readOnly: readOnly,
    error: error
  })),
...
var Input = function Input(props) {
  ...
  return React__default.createElement(themeUi.Box, {
  ...
  }, React__default.createElement(Input$1.Input, Object.assign({
    value: value,
    onFocus: function onFocus() {
    ...
    }, prefix && React__default.createElement(themeUi.Flex, {
      variant: "input.prefix"
    }, prefix), React__default.createElement(themeUi.Input, Object.assign({}, enhancedProps)), React__default.createElement(themeUi.Label, {
      htmlFor: id,
      variant: labelVariant
    }, label), suffix && React__default.createElement(themeUi.Flex, {
      variant: "input.suffix"
    }, suffix));
  }), React__default.createElement(themeUi.Flex, {
    variant: helpMessageVariant
  }, React__default.createElement(themeUi.Text, null, helpMessage), charLimit && React__default.createElement(themeUi.Text, null, charCount, "/", charLimit)));
};
...
function Popover(props) {
  ...
  return React__default.createElement(React__default.Fragment, null, React__default.createElement(Popover$2.PopoverDisclosure, Object.assign({}, popoverProps, {
    ref: disclosure === null || disclosure === void 0 ? void 0 : disclosure.ref
  }), function (referenceProps) {
    return React.cloneElement(disclosure, _extends({}, referenceProps));
  }), React__default.createElement(Popover$2.Popover, Object.assign({}, popoverProps), arrow && React.cloneElement(arrow, _extends({}, popoverProps)), React__default.createElement(themeUi.Box, {
    variant: "popover",
    sx: sx
  }, children)));
}
...
var Popover$1 = function Popover$1(_ref2) {
  ...
  }, React__default.createElement(Popover, Object.assign({}, props, popover, {
    sx: _extends({}, sx, {
      pr: showClose ? 4 : 0
    }),
    unstable_autoFocusOnShow: false,
    arrow: variant === 'regular' ? React__default.createElement(reakit.PopoverArrow, {
      as: themeUi.Box,
      size: 25,
      variant: "popover.arrow." + popover.placement,
      placement: popover.placement
    }) : undefined
  }), children, showClose && React__default.createElement(themeUi.Box, {
    variant: "popover.close"
  }, React__default.createElement(Button$1, {
    size: "small",
    variant: "tertiary",
    icon: function icon() {
      return React__default.createElement(IconClose, {
        size: 30
      });
    },
...
var HelloBar = function HelloBar(_ref) {
  ...
  var state = Dialog.useDialogState({
    modal: false,
    visible: true
  });
  ...
  return React__default.createElement(Dialog.Dialog, Object.assign({}, state, {
  ...
  }), React__default.createElement(themeUi.Text, null, children)), React__default.createElement(themeUi.Flex, {
    ...
    size: "small"
  }, label), closeIcon && React__default.createElement(Button$1, {
    sx: {
      display: ['none', 'none', 'block']
    },
    variant: "tertiary",
    ...
    icon: function icon() {
      return React__default.createElement(IconClose, Object.assign({}, iconCloseStyle));
    }
  })), React__default.createElement(themeUi.Box, {
    variant: "helloBar.actionIcon"
  }, React__default.createElement(IconCaret, {
    direction: "right"
  })))));
};
...
var Circle = function Circle() {
  ...
  }, React__default.createElement(themeUi.Box, null));
};
...
function Event(_ref) {
  ...
  }, icon !== null && icon !== void 0 ? icon : React__default.createElement(Circle, null), React__default.createElement(themeUi.Box, {
    variant: "timeline.event.line"
  })), React__default.createElement(themeUi.Box, {
    variant: "timeline.event"
  }, React__default.createElement(themeUi.Box, {
    variant: "timeline.event.title"
  }, title), subtitle && React__default.createElement(themeUi.Box, {
    variant: "timeline.event.subtitle"
  }, subtitle), children && React__default.createElement(themeUi.Box, {
...
var getWeekDays = function getWeekDays(locale) {
  var weekdays = luxon.Info.weekdays('narrow', {
    locale: locale
  });
...
var today = /*#__PURE__*/luxon.DateTime.local();
...
var Day = function Day(_ref2) {
  ...
  if (RenderComponent) {
    return themeUi.jsx(RenderComponent, Object.assign({
      value: value,
      variant: variant,
      onClick: _onClick,
      selectedDate: selectedDate,
      events: events
    }, restProps), themeUi.jsx(themeUi.Text, null, value.day), themeUi.jsx(EventTag, {
      event: event
    }));
  }
  ...
  }, restProps), themeUi.jsx(themeUi.Text, null, value.day), event && themeUi.jsx(EventTag, {
    event: event
  }));
};
...
var Calendar = function Calendar(_ref3) {
  var _ref3$day = _ref3.day,
      ...
      _ref3$sx = _ref3.sx,
      sx = _ref3$sx === void 0 ? {} : _ref3$sx;
  var date = luxon.DateTime.local(year, month, day).setLocale(locale);
  ...
  }, date.toFormat('MMMM yyyy')), headerAccessory), themeUi.jsx(themeUi.Grid, {
...
var useCarouselState = function useCarouselState(_ref) {
  ...
  var _useState = React.useState(initialStep),
...
var Carousel = function Carousel(_ref) {
  ...
  return React__default.createElement(themeUi.Flex, {
    variant: "carousel",
    sx: sx
  }, React__default.createElement(themeUi.Flex, null, React__default.createElement(NavigationContainer, {
    direction: "previous",
  ...
  }), React__default.createElement(SlidesContainer, {
    transition: transition,
    swipeHandlers: swipeHandlers,
    slides: slides,
    currentStep: currentStep,
    ...
    slidesPerScroll: slidesPerScroll,
    slidesPerPage: slidesPerPage
  }), React__default.createElement(NavigationContainer, {
    direction: "next",
    overlaySlides: overlaySlides,
    buttonAlign: buttonAlign,
    ...
    size: size,
    visible: !stopAtEnd
  })), indicators && React__default.createElement(ProgressIndicatorBar, {
    overlaySlides: overlaySlides,
    totalSteps: totalSteps,
    handleChangeStep: handleChangeStep,
    currentStep: currentStep
...
var NavigationContainer = function NavigationContainer(_ref2) {
  ...
  }), React__default.createElement(VisuallyHidden.VisuallyHidden, null, direction, " step")));
};
...
var SlidesContainer = function SlidesContainer(_ref3) {
  ...
  }, React__default.createElement(themeUi.Flex, Object.assign({}, swipeHandlers, {
...
var ProgressIndicator = function ProgressIndicator(_ref5) {
  ...
  }, React__default.createElement(VisuallyHidden.VisuallyHidden, null, "Step ", step));
};
...
var backdropAnimation = /*#__PURE__*/core.css( /*#__PURE__*/_templateObject$2());
var surfaceAnimation = /*#__PURE__*/core.css( /*#__PURE__*/_templateObject2());

var CloseButton = function CloseButton(_ref) {
  var handleClose = _ref.handleClose;
  return themeUi.jsx(Button$1, {
    icon: function icon() {
      return themeUi.jsx(IconClose, {
        size: 39
      });
    },
...
var ModalButton = function ModalButton(props) {
  ...
  return themeUi.jsx(Button$1, Object.assign({
    sx: {
      marginLeft: '1rem'
    }
  }, args), children);
...
var BottomBar = function BottomBar(_ref3) {
  ...
  return themeUi.jsx(themeUi.Flex, {
...
var Modal = function Modal(_ref5) {
  ...
  return themeUi.jsx(React.Fragment, null, themeUi.jsx(Dialog.DialogDisclosure, Object.assign({}, state), function (disclosureProps) {
    return React.cloneElement(disclosure, _extends({}, disclosureProps));
  }), themeUi.jsx(Dialog.DialogBackdrop, Object.assign({}, state, {
    css: state.animated && backdropAnimation,
    variant: "modal.backdrop",
    as: themeUi.Box
  }), themeUi.jsx(Dialog.Dialog, Object.assign({}, state, {
    css: state.animated && surfaceAnimation,
    variant: "modal.box." + variant,
    as: themeUi.Box,
    hideOnClickOutside: false
  }), variant === 'modal' ? themeUi.jsx(Title$1, {
    title: title,
    handleClose: handleClose
  }) : themeUi.jsx(themeUi.Box, {
...
var Toast = function Toast(_ref) {
  ...
  return themeUi.jsx(reakit.DisclosureContent, Object.assign({}, disclosure, {
    sx: {
      variant: 'toast'
    }
  }), children, themeUi.jsx(themeUi.Box, {
    variant: "toast.actionContainer",
    sx: {
      mt: [actionText ? 4 : 0, 0]
    }
  }, actionText && themeUi.jsx(reakit.Button, {
    sx: {
      my: 0,
      py: 0,
      color: 'white',
  ...
  }, actionText), themeUi.jsx(reakit.Disclosure, Object.assign({}, disclosure, {
    sx: {
      color: 'white',
...
var useToast = function useToast(props) {
  ...
  var createToast = function createToast(text) {
    addToast(themeUi.jsx(Toast, Object.assign({}, props), themeUi.jsx(themeUi.Text, {
      variant: "toast.text"
    }, text)));
  };
...
var Select = function Select(props) {
  ...
  return themeUi.jsx(themeUi.Box, {
  ...
  }, themeUi.jsx(reakit.Box, Object.assign({
    as: "select",
    id: id,
    ref: ref,
    value: value,
    ...
    disabled: isDisabled
  }, restProps), children), themeUi.jsx(IconCaret, {
    sx: {
  ...
  }, label)), themeUi.jsx(themeUi.Flex, {
    variant: helpMessageVariant
  }, themeUi.jsx(themeUi.Text, null, helpMessage)));
};
...
var load = /*#__PURE__*/core.keyframes("\n  0% {\n    background-position: -200px 0;\n  }\n  100% {\n    background-position: calc(200px + 100%) 0;\n  }");
var Skeleton = function Skeleton(props) {
  ...
  return React__default.createElement(themeUi.Box, Object.assign({}, props, {
    css: core.css(_templateObject$3(), load),
...
var useTextareaState = function useTextareaState(_ref2) {
  ...
  var _useState5 = React.useState(resolveTextareaState({
    disabled: disabled,
    readOnly: readOnly,
    error: error,
    filled: filled
...
var Textarea = function Textarea(props) {
  ...
  return themeUi.jsx(themeUi.Box, {
    ...
    sx: sx
  }, themeUi.jsx("textarea", Object.assign({
    id: id,
    ref: ref,
    placeholder: " ",
    maxLength: charLimit,
  ...
  }, TextareaProps, state)), themeUi.jsx(themeUi.Label, {
    htmlFor: id,
    variant: labelVariant
  }, label), themeUi.jsx(themeUi.Flex, {
    variant: helpMessageVariant
  }, themeUi.jsx(themeUi.Text, null, helpMessage), charLimit && themeUi.jsx(themeUi.Text, null, charCount, "/", charLimit)));
};
...
exports.FooterLanding = FooterLanding;
...
exports.IconVTEX = IconVTEX;
exports.IconVTEXExpanded = IconVTEXExpanded;
exports.IconVTEXSymbol = IconVTEXSymbol;
...
exports.useFocusHollow = useFocusHollow;
